...
async def run_training_script(script_path: str, training_type: str = "advanced") -> Dict:
    ...
    try:
        ...
        use_rapids = training_type == "advanced" and os.path.exists("scripts/rapids_gpu_forecasting.py")
        
        if use_rapids:
            training_status["current_step"] = "Initializing RAPIDS GPU training..."
            training_status["logs"].append("🚀 RAPIDS GPU acceleration enabled")
            script_path = "scripts/rapids_gpu_forecasting.py"
...
async def start_training(request: TrainingRequest, background_tasks: BackgroundTasks):
    ...
    if request.training_type == "basic":
        script_path = "scripts/phase1_phase2_forecasting_agent.py"
        estimated_duration = "5-10 minutes"
    else:
        script_path = "scripts/phase3_advanced_forecasting.py"
