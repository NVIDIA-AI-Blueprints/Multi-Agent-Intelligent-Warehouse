...
async def get_reasoning_insights(session_id: str):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to get reasoning insights: {str(e)}")
    ...
    try:
        ...
        enhanced_response = {
            ...
            "insights": {
                ...
                "confidence_level": "High" if reasoning_chain.overall_confidence > 0.8 else "Medium" if reasoning_chain.overall_confidence > 0.6 else "Low"
            }
        }
        ...
        raise HTTPException(status_code=500, detail=f"Chat with reasoning failed: {str(e)}")
