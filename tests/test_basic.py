...
def test_mcp_services_import():
    ...
    try:
        ...
        from chain_server.services.mcp.tool_routing import ToolRoutingService
...
def test_reasoning_engine_import():
    ...
    try:
        from chain_server.services.reasoning.reasoning_engine import AdvancedReasoningEngine
